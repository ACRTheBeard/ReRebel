...
| GID: uprising | Alt-2 | |
| GID: idle fleets | Alt-3 | |
| GID: enroute fleets | Alt-4 | |
| GID: idle personnel | Alt-5 | |
| GID: active personnel | Alt-6 | |
| GID: idle shipyard | Alt-7 | |
| GID: idle training facilities | Alt-8 | |
| GID: idle construction | Alt-9 | |

GID = galactic-idle display filters (per README grouping).
